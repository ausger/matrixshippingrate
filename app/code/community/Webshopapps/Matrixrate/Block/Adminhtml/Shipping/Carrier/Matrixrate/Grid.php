...
class Webshopapps_Matrixrate_Block_Adminhtml_Shipping_Carrier_Matrixrate_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  ...
  /**
    ...
    {
        $this->addColumn('depart_country', array(
            'header'    => Mage::helper('adminhtml')->__('Departure Country'),
            'index'     => 'depart_country',
            'default'   => '*',
        ));

        $this->addColumn('dest_country', array(
            'header'    => Mage::helper('adminhtml')->__('Destination Country'),
            'index'     => 'dest_country',
            'default'   => '*',
        ));
