...
CREATE TABLE IF NOT EXISTS {$this->getTable('shipping_matrixrate')} (
  ...
  depart_country_id varchar(4) NOT NULL default '0',
  dest_country_id varchar(100) NOT NULL default '0',
  ...
  PRIMARY KEY(`pk`),
  UNIQUE KEY `dest_country` (`website_id`,`depart_country_id`,`dest_country_id`,`dest_region_id`,`dest_city`,`dest_zip`,`dest_zip_to`,`condition_name`,`condition_from_value`,`condition_to_value`,`delivery_type`)
